...
class LoopData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.split == 'train':
            loop_ims, loop_labels, loop_edges, loop_corners, loop_accs = building.create_loops_sample_cmp(phase="train")
        else:
            loop_ims, loop_labels, loop_edges, loop_corners, loop_accs = building.create_loops_sample_cmp()
        return loop_ims, loop_labels, loop_edges, loop_corners, loop_accs, index
