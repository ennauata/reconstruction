...
class GraphData(Dataset):
    ...
    def add_remove_edges(self, imgs, edges_state, edges_gt, e_xys, k):
    ...
    def remove_incident_edges(self, imgs, edges_state, corners_gt, e_xys, corner_edge, c):
    ...
    # def generate_input_tuple(self, corners_gt, edges_gt, e_xys, corner_edge, current_edges, imgs, n_max=64, N=4):
    ...
    #         for k in inds:
    #             # flip k-th edge
    #             sample_with_cnn, sample_with_cnn_rev, label_with_cnn, label_with_cnn_rev, prob_with_cnn, dist_with_cnn = self.add_remove_edges(imgs, aux_current_edges, edges_gt, e_xys, k)
    ...
    #             # update using cnn
    #             if prob_with_cnn > .5:
    #                 aux_current_edges[k] = abs(1.0-aux_current_edges[k])
    ...
    #         # flip k-th edge
    #         sample_with_gt, sample_with_gt_rev, label_with_gt, label_with_gt_rev, prob_with_gt, dist_with_gt = self.add_remove_edges(imgs, aux_current_edges, edges_gt, e_xys, k)

    #         # accumul samples
    #         samples.append(sample_with_gt)
    #         targets.append(label_with_gt)
    #         samples.append(sample_with_gt_rev)
    #         targets.append(label_with_gt_rev)
    ...
    #         # im1 = Image.fromarray((sample_with_gt[4, :, :, ]>0)*255.0)
    #         # im2 = Image.fromarray((sample_with_gt[5, :, :]>0)*255.0)

    #         # plt.figure()
    #         # plt.imshow(rgb)
    #         # # plt.figure()
    #         # # plt.imshow(Image.fromarray(im_s0*255.0).convert('RGB'))
    #         # plt.imshow(im1)
    #         # plt.figure()
    #         # plt.imshow(im2)
    #         # plt.show()
